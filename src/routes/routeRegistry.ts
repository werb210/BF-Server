...
export const ROUTES: ApiRoute[] = [
  ...
  { method: "POST", path: "/api/webhooks/twilio/recording/status", roles: [] },
  { method: "POST", path: "/api/webhooks/twilio/transcription/event", roles: [] },
  ...
  { method: "GET", path: "/api/crm/contacts/:id/stage-events", roles: [ROLES.ADMIN, ROLES.STAFF, ROLES.MARKETING] },
  ...
  { method: "PATCH", path: "/api/lender/products/:id", roles: [ROLES.LENDER] },
  ...
  { method: "GET", path: "/api/client/signing-session", roles: [] },
