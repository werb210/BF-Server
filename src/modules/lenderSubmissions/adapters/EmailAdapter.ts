// BF_SERVER_BLOCK_v336_RESTORE_EMAIL_ADAPTER_v1
// Restored from v335 over-deletion. This adapter is live: called by
// src/services/lenders/dispatchToSelected.ts which is called by the
// background lenderPackageWorker and the submissionOrchestration route.
