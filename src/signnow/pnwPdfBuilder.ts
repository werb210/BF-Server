...
export async function buildPnwPdfFromData(payload: PnwPayload): Promise<Uint8Array> {
  ...
  // v_SIGNNOW_DATE_TAG_FIX: date field (t:t text + "Date" label; date-type t:d breaks fieldextract 65656).
  T(p2, '{{t:t;r:y;o:"Owner 1";l:"Date";w:90;h:16;}}', M + sigW + 32, y2 - 3, 6, F, WHITE);
