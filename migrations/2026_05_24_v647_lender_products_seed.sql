...
-- 2. rate_kind CHECK constraint — already created by migration v640 with
--    canonical lowercase short codes ('apr','monthly','factor'). v647 uses
--    the same values, so no constraint changes here. The Lender Product
--    portal modal renders the short codes as human-friendly labels
--    ("APR %", "Monthly %", "Factor (MCA)") for staff.
...
-- 5. Backfill rate_kind on legacy rows is already handled by v640.
-- This block is intentionally a no-op for forward compatibility.
...
VALUES
  ...
  (gen_random_uuid(), (SELECT id FROM lenders WHERE name = 'Pearl Capital Final' LIMIT 1), 'Pearl Capital Final', 'MCA', 'TERM'::lender_product_category, 'Term Loan', 'US', 35000, 149999, 'factor', 1.24, 1.45, 3, 9, 'MONTHS', TRUE, 'ACTIVE', 'Bank Statements; Profit and Loss Statement; Balance Sheet; Accountant Prepared Financials', NOW(), NOW()),
  (gen_random_uuid(), (SELECT id FROM lenders WHERE name = 'Pearl Capital Final' LIMIT 1), 'Pearl Capital Final', 'MCA', 'TERM'::lender_product_category, 'Term Loan', 'US', 10000, 34999, 'factor', 1.24, 1.45, 3, 9, 'MONTHS', TRUE, 'ACTIVE', 'Bank Statements', NOW(), NOW()),
  (gen_random_uuid(), (SELECT id FROM lenders WHERE name = 'Pearl Capital Final' LIMIT 1), 'Pearl Capital Final', 'MCA', 'TERM'::lender_product_category, 'Term Loan', 'US', 250000, 1000000, 'factor', 1.24, 1.45, 3, 9, 'MONTHS', TRUE, 'ACTIVE', 'Bank Statements; Profit and Loss Statement; Balance Sheet; Accountant Prepared Financials', NOW(), NOW()),
  (gen_random_uuid(), (SELECT id FROM lenders WHERE name = 'Pearl Capital Final' LIMIT 1), 'Pearl Capital Final', 'MCA', 'TERM'::lender_product_category, 'Term Loan', 'US', 150000, 249999, 'factor', 1.24, 1.45, 3, 9, 'MONTHS', TRUE, 'ACTIVE', 'Bank Statements; Profit and Loss Statement; Balance Sheet; Accountant Prepared Financials', NOW(), NOW()),
  ...
  (gen_random_uuid(), (SELECT id FROM lenders WHERE name = 'Revenued' LIMIT 1), 'Revenued', 'Flex Line', 'LOC'::lender_product_category, 'Business Line of Credit', 'CA', 3000, 19999, 'factor', 1.25, 1.45, 10, 10, 'MONTHS', TRUE, 'ACTIVE', 'Bank Statements', NOW(), NOW()),
  ...
  (gen_random_uuid(), (SELECT id FROM lenders WHERE name = 'Revenued' LIMIT 1), 'Revenued', 'Flex Line', 'LOC'::lender_product_category, 'Business Line of Credit', 'US', 250000, 500000, 'factor', 1.25, 1.45, 10, 10, 'MONTHS', TRUE, 'ACTIVE', 'Bank Statements; Balance Sheet; Profit and Loss Statement; Accountant Prepared Financials', NOW(), NOW()),
  (gen_random_uuid(), (SELECT id FROM lenders WHERE name = 'Revenued' LIMIT 1), 'Revenued', 'Flex Line', 'LOC'::lender_product_category, 'Business Line of Credit', 'US', 150000, 249999, 'factor', 1.25, 1.45, 10, 10, 'MONTHS', TRUE, 'ACTIVE', 'Bank Statements; Balance Sheet; Accountant Prepared Financials; Profit and Loss Statement', NOW(), NOW()),
  (gen_random_uuid(), (SELECT id FROM lenders WHERE name = 'Revenued' LIMIT 1), 'Revenued', 'Flex Line', 'LOC'::lender_product_category, 'Business Line of Credit', 'US', 20000, 149999, 'factor', 1.25, 1.45, 10, 10, 'MONTHS', TRUE, 'ACTIVE', 'Bank Statements; Profit and Loss Statement; Balance Sheet; Accountant Prepared Financials', NOW(), NOW()),
  (gen_random_uuid(), (SELECT id FROM lenders WHERE name = 'Revenued' LIMIT 1), 'Revenued', 'Flexline', 'TERM'::lender_product_category, 'Term Loan', 'US', 250000, 500000, 'factor', 1.25, 1.45, 3, 9, 'MONTHS', TRUE, 'ACTIVE', 'Bank Statements; Profit and Loss Statement; Balance Sheet; Accountant Prepared Financials', NOW(), NOW()),
  (gen_random_uuid(), (SELECT id FROM lenders WHERE name = 'Revenued' LIMIT 1), 'Revenued', 'Flexline', 'TERM'::lender_product_category, 'Term Loan', 'US', 20000, 149999, 'factor', 1.25, 1.45, 3, 9, 'MONTHS', TRUE, 'ACTIVE', 'Bank Statements; Profit and Loss Statement; Balance Sheet; Accountant Prepared Financials', NOW(), NOW()),
  (gen_random_uuid(), (SELECT id FROM lenders WHERE name = 'Revenued' LIMIT 1), 'Revenued', 'Flexline', 'TERM'::lender_product_category, 'Term Loan', 'US', 150000, 249000, 'factor', 1.25, 1.45, 3, 9, 'MONTHS', TRUE, 'ACTIVE', 'Bank Statements; Profit and Loss Statement; Balance Sheet; Accountant Prepared Financials', NOW(), NOW()),
  (gen_random_uuid(), (SELECT id FROM lenders WHERE name = 'Revenued' LIMIT 1), 'Revenued', 'Flexline', 'LOC'::lender_product_category, 'Business Line of Credit', 'US', 5000, 19999, 'factor', 1.25, 1.45, 3, 9, 'MONTHS', TRUE, 'ACTIVE', 'Bank Statements', NOW(), NOW()),
