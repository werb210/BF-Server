...
function generateVoiceToken(identity) {
    const token = new AccessToken_1.default(config_1.config.twilio.accountSid, requireTokenConfig(config_1.config.twilio.apiKey, "TWILIO_API_KEY"), requireTokenConfig(config_1.config.twilio.apiSecret, "TWILIO_API_SECRET"), { identity });
    const grant = new AccessToken_1.VoiceGrant({
