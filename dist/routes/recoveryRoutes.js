...
/* AUTH */
router.post("/auth/otp/start", (_req, res) => ok(res));
router.post("/auth/otp/verify", (_req, res) => res["json"]({ ok: true, token: "dev" }));
...
/* TELEPHONY */
router.get("/telephony/token", (_req, res) => res["json"]({ ok: true, token: "dev" }));
